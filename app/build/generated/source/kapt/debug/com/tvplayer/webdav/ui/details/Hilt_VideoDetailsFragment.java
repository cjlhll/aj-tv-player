...
public abstract class Hilt_VideoDetailsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_VideoDetailsFragment() {
    super();
  }

  Hilt_VideoDetailsFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((VideoDetailsFragment_GeneratedInjector) this.generatedComponent()).injectVideoDetailsFragment(UnsafeCasts.<VideoDetailsFragment>unsafeCast(this));
    }
  }
