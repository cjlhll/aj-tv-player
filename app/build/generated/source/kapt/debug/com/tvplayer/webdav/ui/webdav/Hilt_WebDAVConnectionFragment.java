...
public abstract class Hilt_WebDAVConnectionFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_WebDAVConnectionFragment() {
    super();
  }

  Hilt_WebDAVConnectionFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((WebDAVConnectionFragment_GeneratedInjector) this.generatedComponent()).injectWebDAVConnectionFragment(UnsafeCasts.<WebDAVConnectionFragment>unsafeCast(this));
    }
  }
