...
public abstract class Hilt_ScannerFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ScannerFragment() {
    super();
  }

  Hilt_ScannerFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ScannerFragment_GeneratedInjector) this.generatedComponent()).injectScannerFragment(UnsafeCasts.<ScannerFragment>unsafeCast(this));
    }
  }
